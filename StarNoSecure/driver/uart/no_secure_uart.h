#ifndef _NO_SECURE_UART_H_
#define _NO_SECURE_UART_H_
...
extern void no_secure_uart_init(uint32_t baud_rate, uint8_t rx_fifo_thr);
extern int bk_no_secure_printf(const char *fmt, ...);
#endif
