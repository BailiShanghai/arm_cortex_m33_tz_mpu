...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START4     0x70000000      /* start address of SAU region 4 */
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START5     0x40000000

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END5       0x400007FF
...
#define SAU_INIT_REGION(n) \
	...
	{\
	    ...
	    bk_secure_printf("\r\nSAU_INIT_REGION:%d\r\n", n);\
	    bk_secure_printf("SAU->RNR:0x%x\r\n", SAU->RNR);\
	    bk_secure_printf("SAU->RBAR:0x%x\r\n", SAU->RBAR);\
	    bk_secure_printf("SAU->RLAR:0x%x\r\n", SAU->RLAR);\
	}\
	while (0)
